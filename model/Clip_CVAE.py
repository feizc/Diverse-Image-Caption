...
# time concatenation fusion for CLIP-CVAE 
class ClipCVAE(nn.Module): 
    def __init__(self, prefix_len=5, model_d=768, project_hidden_size=64, clip_d=512, learn_prior=True):
        super(ClipCVAE, self).__init__() 
        self.learn_prior = learn_prior 

        self.priornet = MLP((clip_d, project_hidden_size, model_d*prefix_len))
        self.posternet = MLP((clip_d*2, project_hidden_size, model_d*prefix_len))
